...
public class WordCount_LambdaTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // lambda表达式中如果涉及到泛型参数，那么会造型泛型擦除，lambda表达式只会在编译的时候进行类型的校验，编译之后泛型参数就会丢失，所以，lambda表达式中，泛型参数是无法直接使用的
        // class是编译完成的class，所以，泛型参数在编译完之后被擦除，所以无法直接使用泛型.class
