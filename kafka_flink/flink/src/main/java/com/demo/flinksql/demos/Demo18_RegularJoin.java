...
public class Demo18_RegularJoin {
    public static void main(String[] args) {
        ...
        //  left  join
        tenv.executeSql("select a.f0,a.f1,a.f2,b.f0,b.f1  from t_left  a  left join t_right b on a.f0=b.f0")/*.print()*/;

        // inner join
        tenv.executeSql("select a.f0,a.f1,a.f2,b.f0,b.f1  from t_left  a  join t_right b on a.f0=b.f0").print();
